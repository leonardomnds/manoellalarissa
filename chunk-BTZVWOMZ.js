import{l as s}from"./chunk-BZ6GZT4Y.js";import{Aa as o,T as a,Z as n,_b as c}from"./chunk-G2QE2KQT.js";var i={production:!0,crp:"08/35519",whatsappUrl:"https://wa.me/+5545988095864",instagramUrl:"https://www.instagram.com/psi.manoella",googleMapsUrl:"https://maps.app.goo.gl/tPngVoJxaC3V9f4h6",clarityKey:"mpu5lu4426",googleAdsKey:"AW-16611235965"};var y=(()=>{let t=class t{constructor(){this.deveExecutar=s(n(o))&&!c()}initialize(){this.deveExecutar&&(this.initializeClarity(),this.initializeGoogleAds())}trackGoogleAdsConversion(){!this.deveExecutar||!i.googleAdsKey||typeof window.gtag=="function"&&window.gtag("event","conversion",{send_to:`${i.googleAdsKey}/GniOCK_5wroZEP2w7fA9`})}initializeClarity(){if(!this.deveExecutar||!i.clarityKey)return;let e=document.createElement("script");e.innerHTML=`(function(c,l,a,r,i,t,y){
